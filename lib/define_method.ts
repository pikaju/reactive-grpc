...
type DereactifyMethod<RequestType, ResponseType, ReactiveMethodType extends ReactiveMethod<RequestType, ResponseType>> =
  ReactiveMethodType extends ReactiveUnaryMethod<RequestType, ResponseType>
  ? grpc.handleUnaryCall<RequestType, ResponseType>
  : ReactiveMethodType extends ReactiveClientStreamMethod<RequestType, ResponseType>
  ? grpc.handleClientStreamingCall<RequestType, ResponseType>
  : ReactiveMethodType extends ReactiveServerStreamMethod<RequestType, ResponseType>
  ? grpc.handleServerStreamingCall<RequestType, ResponseType>
  :ReactiveMethodType extends ReactiveBidirectionalStreamMethod<RequestType, ResponseType>
...
>(method: ReactiveMethodType): DereactifyMethod<RequestType, ResponseType, ReactiveMethodType> {
  return null as unknown as DereactifyMethod<RequestType, ResponseType, ReactiveMethodType>;
}
